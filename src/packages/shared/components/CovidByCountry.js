...
const  EnhancedTableHead = ({ classes, order, orderBy, onRequestSort }) =>  {
  ...
  const headCells = [
    { id: 'Country', numeric: false, disablePadding: true, label: 'Countries' },
    { id: 'TotalConfirmed', numeric: true, disablePadding: false, label: 'Total Cases' },
    { id: 'TotalDeaths', numeric: true, disablePadding: false, label: 'Total Deaths' },
    { id: 'NewConfirmed', numeric: true, disablePadding: false, label: 'New Cases' },
